 ...
 */
public class ContentCachingRequestWrapper2 extends HttpServletRequestWrapper {
	...
	/**
	 * Create a new ContentCachingRequestWrapper2 for the given servlet request.
	 * @param request the original servlet request
	 */
	public ContentCachingRequestWrapper2(HttpServletRequest request) {
		super(request);
	 ...
	 */
	public ContentCachingRequestWrapper2(HttpServletRequest request, int contentCacheLimit) {
		super(request);
	 ...
	 * @see #ContentCachingRequestWrapper2(HttpServletRequest, int)
	 */
